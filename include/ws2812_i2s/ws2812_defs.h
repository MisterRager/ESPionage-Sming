...
void (*rom_i2c_writeReg_Mask)(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int) =
  (void (*)(unsigned int, unsigned int, unsigned int, unsigned int, unsigned int, unsigned int)) 0x4000730c;
// -----------------------------------------------------
